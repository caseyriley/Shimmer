...
about how to use Redux instead of React Context for state-management. Today,
you'll learn how to build your application with React Context and Hooks!
...
As your might remember, your current application is comprised of the following
components:
...
## Phase 2: State-based hooks application
...
## Phase 3: Using hooks to manage application state

Now that you've refactored a project to make use of the `useState` and
`useEffect` hooks, it's time to manage your application's state with the
`useContext` hook!
...
[double not]:
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Logical_Operators#Double_NOT_!!
